...
# Import necessary modules from your code
...
class YourApp(App):
    def build(self):
        # Create the main layout for your Kivy app
        layout = BoxLayout(orientation='vertical')

        # Create a button that triggers your code
        start_button = Button(text='Start Race', on_press=self.start_race)
        stop_button = Button(text='Stop Race', on_press=self.stop_race)
        layout.add_widget(start_button)
        layout.add_widget(stop_button)

        # Return the main layout as the root widget
        return layout
    def stop_race(self, instance):
    # Stop any running threads or loops
        self.running = False
    def start_race(self, instance):
        ...
        while True:
            ...
            if state == 100 and "1,165" in extracted_text:
                #race
            ...
            elif state == 2 and wet == 1 and "LAP5" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
            ...
            #Barcelona one stop
                ...
                time.sleep(1)
                #PIA hard
                device.shell('input touchscreen tap 302 1970')
                time.sleep(1)
                #PIAserv
                device.shell('input touchscreen tap 290 1856')
            ...
            elif state == 155 and ("LAP 5" in extracted_text or "LAP5" in extracted_text) and "Rain" in extracted_text:
                #lec pitstop
                time.sleep(5)
                device.shell('input touchscreen tap 820 2265')
                #lec wets
            ...
            elif state == 12 and wet == 0 and "LAP 7" in extracted_text and "Rain" in extracted_text:
                time.sleep(1)
                #lec pitstop
                time.sleep(1)
                device.shell('input touchscreen tap 820 2265')
            ...
            elif state == 23 and "LAP5" in extracted_text:
                #lec pitstop
                time.sleep(1)
                device.shell('input touchscreen tap 820 2265')
                time.sleep(1)
            ...
            elif state == 73 and "LAP 4" in extracted_text:
                time.sleep(1)
                #stop lec boost
                device.shell('input touchscreen tap 990 1630')
                time.sleep(5)
            ...
            elif state == 74 and "6/6" in extracted_text:
                time.sleep(1)
                #boost LEC
                device.shell('input touchscreen tap 1000 1480')
                time.sleep(1)
