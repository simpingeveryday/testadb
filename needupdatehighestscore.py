...
while True:
    ...
    elif state == 101 and "MIAMI" in extracted_text:
        time.sleep(20)
        state = 150
        print("MIAMI")
    ...
    #check for num of laps and rain
        ...
        if cloudloc[0].size > 0:
            ...
            print("lap7")
            #lechards
            device.shell('input touchscreen tap 900 1356')
            time.sleep(1)
            #medium2nddriver
            device.shell('input touchscreen tap 300 1156')
            time.sleep(1)
    ...
    elif state == 0.0 and "1/7" in extracted_text:
        time.sleep(1)
        #tap lec
    ...
    elif state == 0.3 and wet == 0 and "LAP5" in extracted_text and ("Rain" in extracted_text or "rain" in extracted_text) and "/7" in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
        ...
        state = 0.4
        wet = 1
    elif state == 0.3 and ("LAP5" in extracted_text or "LAP 5" in extracted_text) and "Rain" not in extracted_text and "/7" in extracted_text:
        # #lec pitstop
        # time.sleep(1)
        # device.shell('input touchscreen tap 820 2265')
        # time.sleep(1)
    ...
    elif state == 1 and ("LAP 3" in extracted_text or "LAP3" in extracted_text) and "/8" in extracted_text:
        #lec pitstop
        time.sleep(2)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    elif state == 2 and ("LAP 4" in extracted_text or "LAP4" in extracted_text) and "/8" in extracted_text:
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1)
        #2nddriversoft
    ...
    #raining but previously car not fitted with wets
    elif state == 3 and wet == 0 and "LAP5" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
    ...
    elif state == 3 and wet == 1 and "LAP5" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
    ...
    elif state == 3 and ("LAP5" in extracted_text or "LAP 5" in extracted_text) and "/8" in extracted_text and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
        ...
        state = 4
        wet = 0
    elif state == 4 and ("LAP6" in extracted_text or "LAP 6" in extracted_text) and "/8" in extracted_text and "Rain" not in extracted_text:
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1)
        #2nddriversoft
    ...
    elif state == 4 and wet == 0 and "LAP6" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
    ...
    elif state == 4 and wet == 1 and "LAP 6" in extracted_text and "/8" in extracted_text and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(2)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    elif state == 5 and "8/8" in extracted_text and "/8" in extracted_text:
        #boost lec
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
        #boost pia
    ...
    # elif state == 152 and "LAP 2" in extracted_text and "Rain" in extracted_text:
    #     time.sleep(1)
    #     #PIA pitstop
    #     device.shell('input touchscreen tap 216 2270')
    #     time.sleep(1.5)
    ...
    elif state == 153 and ("LAP 3" in extracted_text or "LAP3" in extracted_text) and "Rain" in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
    ...
    elif state == 154 and ("LAP 5" in extracted_text or "LAP5" in extracted_text) and "Rain" in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
    ...
    elif state == 154 and ("LAP 5" in extracted_text or "LAP5" in extracted_text) and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    # elif state == 156 and "LAP6" in extracted_text:
    #     #boost lec
    #     device.shell('input touchscreen tap 1000 1480')
    #     time.sleep(1)
    #     #PIA pitstop
    ...
    #     state = 157
    ...
    elif state == 155 and "7/7" in extracted_text:
        #boost LEC
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
        #boost PIA
    ...
    elif state == 11 and "LAP 4" in extracted_text and "Rain" in extracted_text:
        time.sleep(5)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1.5)
        ...
        state = 12
        wet = 0
    elif state == 12 and ("LAP 5" in extracted_text or "LAP5" in extracted_text) and "Rain" not in extracted_text:
        time.sleep(1)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1)
    ...
    elif state == 13 and wet == 0 and "LAP 7" in extracted_text and "Rain" in extracted_text:
        time.sleep(1)
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
    ...
    elif state == 13 and ("LAP 7" in extracted_text or "LAP7" in extracted_text or "LAP?" in extracted_text) and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
        ...
        state = 15
        wet = 0
    elif state == 14 and "10/10" in extracted_text:
        #boost LEC
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
        #boost PIA
    ...
    elif state == 23 and "LAP 4" in extracted_text and "Rain" not in extracted_text:
       #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1)
        #PIAsoft
    ...
    elif state == 24 and "LAP5" in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    elif state == 23 and "6/6" in extracted_text:
        time.sleep(10)
        #boost LEC
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
    ...
    elif state == 24 and "6/6" in extracted_text:
        #boost LEC
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
        #boost PIA
    ...
    #ZANDVOORT
    ...
    elif state == 33 and wet == 0 and "LAP5" in extracted_text and "Rain" in extracted_text:
        time.sleep(5)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1.5)
        ...
        state = 34
        wet = 1
    elif state == 33 and "LAP5" in extracted_text and "Rain" not in extracted_text:
        time.sleep(1)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1)
        #PIA soft
        device.shell('input touchscreen tap 302 1560')
        time.sleep(1)
        #PIAserv
        device.shell('input touchscreen tap 290 1856')
        time.sleep(15)
    ...
    #BRAZIL SAO PAULO
    ...
    elif state == 62 and "LAP 3" in extracted_text and "Rain" in extracted_text:
        time.sleep(5)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1.5)
    ...
    elif state == 63 and wet != 0 and "LAP 4" in extracted_text and "Rain" in extracted_text:
        time.sleep(5)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1.5)
    ...
    elif state == 63 and "LAP 4" in extracted_text and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(2)
        ...
        state = 64
        wet = 0
    elif state == 64 and ("LAP6" in extracted_text or "LAP6" in extracted_text) and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
        ...
        state = 65
        wet = 0
    elif state == 64 and "LAP 7" in extracted_text and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    elif state == 65 and (wet == 0 or wet == 1) and "LAP 8" in extracted_text and "Rain" in extracted_text:
        time.sleep(5)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1)
    ...
    elif state == 66 and "9/9" in extracted_text:
        #boost LEC
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
        #boost PIA
    ...
    #SPA
        ...
        state = 73
        wet = 1
    elif state == 72 and ("LAP 3" in extracted_text or "LAP3" in extracted_text):
        time.sleep(5)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1.5)
    ...
    # elif state == 73 and ("LAP 5" in extracted_text or "LAP5" in extracted_text):
    #     time.sleep(1)
    #     #stop lec boost
    #     device.shell('input touchscreen tap 990 1630')
    #     time.sleep(5)
    ...
    elif state == 73 and "6/6" in extracted_text:
        time.sleep(1)
        #boost LEC
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
    ...
    elif state == 83 and "LAP 4" in extracted_text and "Rain" not in extracted_text and "/8" in extracted_text:
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1)
        #2nddriversoft
    ...
    #raining but previously car not fitted with wets
    elif state == 84 and wet == 0 and "LAP5" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
    ...
    elif state == 84 and ("LAP6" in extracted_text or "LAP 6" in extracted_text) and "/8" in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    elif state == 84 and wet == 1 and "LAP 6" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
        #lec pitstop
        time.sleep(8)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
    ...
    elif state == 84 and wet == 0 and "LAP 6" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
        #lec pitstop
        time.sleep(8)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
    ...
    elif state == 84 and wet == 1 and "LAP 6" in extracted_text and "/8" in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(2)
    ...
    elif state == 85 and "8/8" in extracted_text and "/8" in extracted_text:
        #boost lec
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
        #boost pia
    ...
    # elif "Standard" in extracted_text:
