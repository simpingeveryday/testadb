...
while True:
    ...
    if state == 100 and "Prize" in extracted_text:
        # device.shell('input touchscreen tap 560 1607')
        # print("race")
        # time.sleep(2)
        # device.shell('input touchscreen tap 560 1350')
        time.sleep(2)
        print("duels")
        device.shell('input touchscreen tap 588 2250')
        time.sleep(2)
        device.shell('input touchscreen tap 550 2250')
        time.sleep(28)
        state = 101
    ...
    elif state == 0.1 and wet == 0 and "LAP 4" in extracted_text and ("Rain" in extracted_text or "rain" in extracted_text) and "/7" in extracted_text:
        #lec pitstop
        time.sleep(8)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
