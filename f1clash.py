...
while True:
    ...
    if state == 100 and "1,089" in extracted_text:
        #race
    ...
    elif state == 0.3 and "7/7" in extracted_text and "/7" in extracted_text:
        #boost lec
        device.shell('input touchscreen tap 1000 1480')
        time.sleep(1)
        #boost pia
    ...
    elif state == 2 and wet == 1 and "LAP6" in extracted_text and "Rain" in extracted_text and "/8" in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
    ...
    elif state == 153 and "LAP 4" in extracted_text and "Rain" in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        #lec wets
    ...
    elif state == 154 and "LAP6" in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(2)
    ...
    elif wet == 1 and state == 13 and "LAP 9" in extracted_text and "Rain" not in extracted_text and "Cloudy" in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(2)
    ...
    elif "Debrief" in extracted_text or "WINNER" in extracted_text or "Activate now" in extracted_text:
        if winnerloc[0].size > 0:
            time.sleep(1)
            winner1 += 1
            race += 1
