...
while True:
    ...
    #check for num of laps and rain
        ...
        state = 0.4
        wet = 1
    elif state == 0.3 and ("LAP5" in extracted_text or "LAP 5" in extracted_text or "LAPS" in extracted_text) and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(sleep_time)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(sleep_time)
    ...
    elif state == 3 and ("LAP 5" in extracted_text or "LAP5" in extracted_text or "LAPS" in extracted_text) and "/8" in extracted_text and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(2)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(sleep_time)
    ...
    elif state == 155 and ("LAP 5" in extracted_text or "LAP5" in extracted_text or "LAPS" in extracted_text) and ("Rain" in extracted_text or "rain" in extracted_text) and "Cloudy" not in extracted_text:
        time.sleep(sleep_time)
        #PIA pitstop
        device.shell('input touchscreen tap 216 2270')
        time.sleep(1.5)
    ...
    elif state == 155 and ("LAP 5" in extracted_text or "LAP5" in extracted_text or "LAPS" in extracted_text) and "Rain" not in extracted_text and "Cloudy" not in extracted_text:
        #lec pitstop
        time.sleep(sleep_time)
        device.shell('input touchscreen tap 216 2265')
        time.sleep(sleep_time)
    ...
    elif (state == 12 or state == 13) and ("LAP 8" in extracted_text or "LAP8" in extracted_text) and ("Rain" in extracted_text or "rain" in extracted_text):
        time.sleep(5)
        #PIA pitstop
        device.shell('input touchscreen tap 820 2270')
        time.sleep(sleep_time)
