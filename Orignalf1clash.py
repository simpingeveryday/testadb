...
while True:
    ...
    elif state == 0.1 and wet == 0 and "LAP 3" in extracted_text and "/7" in extracted_text:
        #lec pitstop
        time.sleep(5)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    elif state == 2 and "LAP5" in extracted_text and "/8" in extracted_text and "Rain" not in extracted_text:
        #lec pitstop
        time.sleep(1)
        device.shell('input touchscreen tap 820 2265')
        time.sleep(1)
    ...
    elif "Debrief" in extracted_text or "WINNER" in extracted_text:
        if winnerloc[0].size > 0:
            time.sleep(1)
            winner1 += 1
            race += 1
